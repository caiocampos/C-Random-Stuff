...
import org.apache.thrift.scheme.*;
...
public class SharedService {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    private static final Logger TLOGGER = LoggerFactory.getLogger(AsyncProcessor.class.getName());
        ...
        return new AsyncMethodCallback<SharedStruct>() { 
          ...
          public void onComplete(SharedStruct o) {
            ...
            try {
              ...
              TLOGGER.error("Exception writing to internal frame buffer", e);
            }
            fb.close();
          }
          @Override
          public void onError(Exception e) {
            ...
            try {
              ...
              TLOGGER.error("Exception writing to internal frame buffer", ex);
            }
            fb.close();
          }
        };
  ...
  public static class getStruct_args implements org.apache.thrift.TBase<getStruct_args, getStruct_args._Fields>, java.io.Serializable, Cloneable, Comparable<getStruct_args>   {
    ...
    public getStruct_args(int key) {
      this();
      this.key = key;
      __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __KEY_ISSET_ID, true);
    }
