...
public class arrowLeftScript : MonoBehaviour, IPointerDownHandler
{
	...
	public void OnPointerDown(PointerEventData eventData)
	{
		...
		character.GetComponent<character> ().isMovingLeft = true;
	...
	{
		//Debug.Log ("Mouse up!");
		character.GetComponent<character> ().isMovingLeft = false;
	}
}
